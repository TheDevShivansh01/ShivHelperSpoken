...
from Handlers.common import send_word_of_the_day,scheduled_send_word,shuffle_all_files_inplace
...
def main():
    ...
    application.add_handler(CommandHandler("shuffle", shuffle_all_files_inplace))
